...
const DEFAULT_PROVIDERS: IProviderInfo[] = [
  ...
  { type: ProviderType.GOOGLE, label: 'Google Gemini', labelEn: 'Google Gemini', defaultBaseUrl: 'https://generativelanguage.googleapis.com', hasQuota: true, icon: '🔵' },
  { type: ProviderType.AZURE, label: 'Azure OpenAI', labelEn: 'Azure OpenAI', defaultBaseUrl: '', hasQuota: true, icon: '☁️' },
