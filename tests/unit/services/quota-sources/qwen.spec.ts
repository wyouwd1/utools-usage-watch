...
import { QwenQuotaAdapter } from '@/services/quota-sources/qwen'

describe('QwenQuotaAdapter (Quota Source)', () => {
  let adapter: QwenQuotaAdapter
  let originalFetch: typeof globalThis.fetch

  beforeEach(() => {
    adapter = new QwenQuotaAdapter()
  ...
  describe('checkQuota', () => {
    it('should parse balance response correctly', async () => {
      ...
      expect(result!.monthly!.total).toBe(200.0)
